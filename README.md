...
- Has cat ears, cat tail, and maid skirt.
  ...
  - The tail stands or dropped depending on the player's health and saturation.
	...
	![Dropping tail](./.github/README_images/drop_tail.jpg)
...
- Smiles or winks in [the action wheel](#the-action-wheel).
  ...
  ![Smile](./.github/README_images/action_smile.gif)

  ![Wink](./.github/README_images/action_wink.gif)
...
- Will be frightened and tremble when a [warden](https://minecraft.wiki/w/Warden) is nearby her (≒ has the darkness effect).
  ...
  - Holds the ball not to make sounds and refuses playing animations when she is frightened.
    ...
    ![Refusing animations](./.github/README_images/refuse_animation.gif)
...
- Plays animations when being left alone for a short while (can be disabled in [avatar settings](#avatar-settings)).
  ...
  ![Touch bell](./.github/README_images/touch_bell.gif)

  - Falls asleep after 5 minutes have passed since she was left alone.

  ![Doze](./.github/README_images/doze.gif)

  ![Fall asleep](./.github/README_images/doze2.gif)

  ![Back from AFK](./.github/README_images/afk.gif)
...
![Shining eyes](./.github/README_images/action_shine_eyes.gif)

#### Action 1-4. Unequaled eyes
Meows and shows unequaled eyes with full of joy.

![Unequaled eyes](./.github/README_images/action_unequal_eyes.gif)

#### Action 1-5. Surprised
Surprised and sweats. Right-click to pale.

![Surprised](./.github/README_images/action_surprised.gif)
...
![Intimidate](./.github/README_images/action_intimidate.gif)

#### Action 1-7. Downhearted
Downhearted. Right-click to pale.

![Downhearted](./.github/README_images/action_downhearted.gif)
...
![Pats head](./.github/README_images/action_pat_head.gif)
...
![Pats tail](./.github/README_images/action_pat_tail.gif)
...
![Avatar settings](./.github/README_images/avatar_settings.jpg)
...
![Cat types](./.github/README_images/various_tails.jpg)
...
![Main texture](./.github/README_images/texture_main.jpg)
...
![Eyes texture](./.github/README_images/texture_eyes.jpg)
...
![Mouth texture](./.github/README_images/texture_mouth.jpg)
