...
LanguageData = {
	en = {
		...
		action_wheel__main__action_6__title = "Cinematic mode",
		action_wheel__main__action_7__title = "Avatar config (unavailable)",
	...
	jp = {
		...
		action_wheel__main__action_6__title = "シネマティックモード",
		action_wheel__main__action_7__title = "アバター設定（使用不可）",
