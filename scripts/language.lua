...
LanguageData = {
	en = {
		...
		action_wheel__main_1__action_1__title = "Meow (smile)",
		action_wheel__main_1__action_2__title = "Meow (wink)",
		action_wheel__main_1__action_3__title = "Meow (shine)",
		action_wheel__main_1__action_4__title = "Surprised",
		action_wheel__main_1__action_5__title = "Intimidate",
		action_wheel__main_2__action_1__title = "Sit down",
		action_wheel__main_2__action_2__title = "Body shake",
		action_wheel__main_2__action_3__title = "§bSummer feature§r: ",
		action_wheel__main_2__action_4__title = "Cinematic mode",
		action_wheel__main_2__action_5__title = "Avatar config (unavailable)",
	...
	jp = {
		...
		action_wheel__main_1__action_1__title = "「ニャー」と鳴く（スマイル）",
		action_wheel__main_1__action_2__title = "「ニャー」と鳴く（ウィンク）",
		action_wheel__main_1__action_3__title = "「ニャー」と鳴く（キラキラ）",
		action_wheel__main_1__action_4__title = "ビックリ",
		action_wheel__main_1__action_5__title = "威嚇",
		action_wheel__main_2__action_1__title = "おすわり",
		action_wheel__main_2__action_2__title = "ブルブル",
		action_wheel__main_2__action_3__title = "§b夏機能§r：",
		action_wheel__main_2__action_4__title = "シネマティックモード",
		action_wheel__main_2__action_5__title = "アバター設定（使用不可）",
