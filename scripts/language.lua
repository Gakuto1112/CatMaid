...
LanguageData = {
	en = {
		...
		action_wheel__main_2__action_2__title = "Sit down",
		action_wheel__main_2__action_3__title = "Body shake",
		action_wheel__main_2__action_4__title = "§bSummer feature§r: ",
		action_wheel__main_2__action_5__title = "Cinematic mode",
		action_wheel__main_2__action_6__title = "Avatar config (unavailable)",
	...
	jp = {
		...
		action_wheel__main_2__action_2__title = "おすわり",
		action_wheel__main_2__action_3__title = "ブルブル",
		action_wheel__main_2__action_4__title = "§b夏機能§r：",
		action_wheel__main_2__action_5__title = "シネマティックモード",
		action_wheel__main_2__action_6__title = "アバター設定（使用不可）",
